...
CAV_MODEL="svm_cav"            # Options: pattern_cav, multi_cav
...
ALPHAS=("0")                     # Non-target pair orthogonality weights
BETAS=("0.1" "1" "10" "100")                   # Target-involving pair orthogonality weights
# TARGET_CONCEPTS="[timestamp,box]"

for ALPHA in "${ALPHAS[@]}"; do
  for BETA in "${BETAS[@]}"; do
    echo "Running model correction experiment with alpha=${ALPHA}, beta=${BETA}"
