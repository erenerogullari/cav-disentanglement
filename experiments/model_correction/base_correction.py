...
class LitClassifier(pl.LightningModule):
    ...
    def configure_optimizers(self):
        sche = torch.optim.lr_scheduler.MultiStepLR(optimizer=self.optim, milestones=[80, 120], gamma=0.1)  # type: ignore
        scheduler = {
            "scheduler": sche,
            "name": "lr_history",
        }
...
class Freeze(Callback):
    ...
    def on_train_epoch_start(self, trainer, pl_module):
        ...
        for n, p in pl_module.model.named_parameters():  # type: ignore
