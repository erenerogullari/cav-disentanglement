...
class CelebASubset(BaseDataset):
    ...
    def __init__(
        ...
        self.metadata = pd.concat(
            [self.metadata.reset_index(drop=True), self.attributes], axis=1
        )
    ...
    # Override
    def do_train_val_test_split(self, val_split=0.1, test_split=0.1, seed=0):
        if all(hasattr(self, attr) for attr in ("idxs_train", "idxs_val", "idxs_test")):
            return self.idxs_train.copy(), self.idxs_val.copy(), self.idxs_test.copy()
...
if __name__ == "__main__":
    ...
    for i in range(10):
        ...
        torchvision.utils.save_image(
            ...
            f"DELETE/celeba_subset_decs/dec{i}.png",
        )
