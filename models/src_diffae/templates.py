...
try:
    ...
    from models.src_diffae.diffusion.base import GenerativeType
    from models.src_diffae.choices import ModelName
except:
    from models.src_diffae.config import TrainConfig, PretrainConfig
    from models.src_diffae.diffusion.base import GenerativeType
